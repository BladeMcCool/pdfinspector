...
gcloud run deploy pdfinspector --image gcr.io/astute-backup-434623-h3/pdfinspector ^
 ...
 --update-secrets="OPENAI_API_KEY=openai-apikey:latest,ADMIN_KEY=admin-key:latest,FRONTEND_SSO_CLIENT_SECRET=frontend-sso-client-secret:latest,JWT_SECRET=jwt-secret:latest" ^
